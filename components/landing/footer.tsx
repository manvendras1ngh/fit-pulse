      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-8 md:flex-row md:items-start md:justify-between">
        ...
        <div className="grid grid-cols-2 gap-8 text-sm md:grid-cols-3">
          ...
          <div className="flex flex-col gap-2">
            ...
            <a href="#" className="py-1 text-fp-text-secondary hover:text-fp-text-primary">About</a>
            <a href="#" className="py-1 text-fp-text-secondary hover:text-fp-text-primary">Blog</a>
          </div>
          <div className="flex flex-col gap-2">
            <p className="font-semibold text-fp-text-primary">Legal</p>
            <a href="#" className="py-1 text-fp-text-secondary hover:text-fp-text-primary">Privacy</a>
            <a href="#" className="py-1 text-fp-text-secondary hover:text-fp-text-primary">Terms</a>
          </div>
        </div>
      </div>
